...
app.post("/register", (req, res) => {
    ...
    if (users[callcode]) {
        return res.send({ success: false, message: "Callcode already taken." });
    }
...
io.on("connection", (socket) => {
    ...
    socket.on("call-user", ({ targetCallcode, offer }) => {
        ...
        io.to(target.socketId).emit("incoming-call", { from: socket.callcode, offer });
    });
    ...
    // End call: relay to the other party
